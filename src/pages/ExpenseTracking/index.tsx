    ...
    <>
      <div className="bg-gray-50 flex flex-col font-gilroy gap-[50px] items-center justify-end mx-auto w-full">
        ...
        <div className="sm:h-[1104px] md:h-[1909px] h-[951px] max-w-[1120px] mx-auto md:px-5 relative w-full">
          <div className="absolute bg-white-A700 bottom-[0] flex flex-col inset-x-[0] items-end justify-start mx-auto p-4 rounded-bl-md rounded-br-md shadow-bs w-[95%] sm:w-full">
            <SelectBox
          ...
          <div className="absolute flex flex-col gap-[50px] h-max inset-[0] items-center justify-center m-auto w-full">
            <div className="bg-blue-A700 flex flex-col items-start justify-start p-[30px] sm:px-5 rounded-md shadow-bs w-full">
            ...
            <div className="flex flex-col items-center justify-end w-full">
              <div className="bg-white-A700 flex flex-col gap-[30px] items-center justify-start p-[30px] sm:px-5 rounded-md shadow-bs w-full">
                <Input
                  name="FrameOne"
                  placeholder="Recent Transactions"
                  className="font-medium p-0 placeholder:text-blue_gray-900 text-left text-lg w-full"
