  ...
  return (
    <>
      <div className="bg-gray-50 flex flex-col font-gilroy gap-[54px] items-center justify-end mx-auto w-full">
        ...
        <div className="flex h-[1011px] sm:h-[1033px] md:h-[1634px] justify-end max-w-[1120px] mx-auto md:px-5 relative w-full">
                ...
                <div className="flex flex-col gap-[31px] items-start justify-start w-full">
                  ...
                  <div className="flex flex-col gap-[30px] items-center justify-start w-full">
                    <div className="flex flex-col items-center justify-start w-full">
                      <div className="bg-blue-50 flex flex-row md:gap-10 items-center justify-between p-2 rounded-tl-md rounded-tr-md w-full">
                        <Text
                          className="ml-4 mt-[7px] text-blue_gray-900 text-lg"
                          size="txtGilroyMedium18Bluegray900"
                        >
                          Activity
                        </Text>
                        <a
                          href="javascript:"
                          className="mr-4 text-blue-A700 text-lg"
                        >
