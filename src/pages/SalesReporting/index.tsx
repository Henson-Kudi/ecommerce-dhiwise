...
const SalesReportingPage: React.FC = () => {
                    ...
                    <div className="bg-white-A700 flex md:flex-1 flex-col gap-5 items-start justify-start p-4 rounded-lg w-[71%] md:w-full">
                      <div className="flex md:flex-col flex-row md:gap-5 items-center justify-start ml-2 md:ml-[0] w-[97%] md:w-full">
                        ...
                        <div className="bg-blue-50 flex sm:flex-col flex-row gap-[18px] items-center justify-center md:ml-[0] ml-[150px] p-2 rounded-md w-[57%] md:w-full">
                          <Button
                            className="cursor-pointer font-medium min-w-[38px] ml-2 sm:ml-[0] rounded-[3px] text-center text-xs"
                            shape="round"
                            color="blue_50"
                            size="sm"
                            variant="fill"
                          ...
                          <Button
                            className="cursor-pointer font-medium min-w-[33px] rounded-[3px] text-center text-xs"
                            shape="round"
                            color="blue_50"
                            size="sm"
                            variant="fill"
                          ...
                          <Button
                            className="cursor-pointer font-medium min-w-[30px] rounded-[3px] text-center text-xs"
                            shape="round"
                            color="blue_50"
                            size="sm"
                            variant="fill"
                          ...
                          <Button
                            className="cursor-pointer font-bold rounded-[3px] text-center text-xs w-[29px]"
                            shape="round"
                            color="blue_A700"
                            size="sm"
                            variant="fill"
                          ...
                          <Button
                            className="cursor-pointer font-medium min-w-[59px] mr-2 rounded-[3px] text-center text-xs"
                            shape="round"
                            color="blue_50"
                            size="sm"
                            variant="fill"
