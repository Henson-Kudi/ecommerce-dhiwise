...
const GraphicalChartsPage: React.FC = () => {
            ...
            <div className="flex flex-1 flex-col gap-[35px] items-start justify-start pt-[5px] w-full">
              <div className="flex flex-col gap-[37px] items-start justify-start w-[90%] md:w-full">
                ...
                <div className="flex md:flex-col flex-row gap-6 items-center justify-between w-full">
                  ...
                  >
                    <div className="bg-white-A700 flex flex-col gap-2.5 items-start justify-start sm:ml-[0] p-4 rounded-md shadow-bs w-full">
                    ...
                    <div className="bg-white-A700 flex flex-col gap-2.5 items-center justify-start sm:ml-[0] p-4 rounded-md shadow-bs w-full">
