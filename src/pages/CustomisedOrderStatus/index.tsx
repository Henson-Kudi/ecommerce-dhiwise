...
const CustomisedOrderStatusPage: React.FC = () => {
          ...
          <div className="flex flex-col gap-4 h-full items-center justify-start ml-auto my-auto w-[77%]">
            ...
            <div className="bg-white-A700 flex flex-col md:gap-10 gap-[729px] justify-start pb-[30px] rounded-lg shadow-bs1 w-full">
              ...
              <div className="flex flex-row gap-2 items-center justify-start md:ml-[0] ml-[774px] w-auto">
                ...
                <Button
                  className="border border-blue_gray-100 border-solid cursor-pointer font-bold font-gilroy h-8 text-center text-sm w-8"
                  shape="round"
                  color="white_A700"
                  size="sm"
                  variant="fill"
                ...
                <Button
                  className="border border-blue_gray-100 border-solid cursor-pointer font-semibold font-sfprotext h-8 text-center text-sm w-8"
                  shape="round"
                  color="white_A700"
                  size="sm"
                  variant="fill"
