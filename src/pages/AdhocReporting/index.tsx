...
const AdhocReportingPage: React.FC = () => {
  return (
    <>
      <div className="bg-gray-50_01 flex sm:flex-col md:flex-col flex-row font-gilroy gap-[30px] items-start mx-auto w-full">
        ...
        <div className="flex-1 sm:h-[1056px] h-[1109px] md:h-[2276px] md:mt-0 mt-6 md:px-5 relative w-full">
          ...
          <div className="absolute bg-gray-50 md:h-[1056px] h-[1109px] inset-y-[0] my-auto pb-[53px] right-[2%] shadow-bs2 w-[23%]">
            <div className="bg-gray-50 h-[1056px] mx-auto shadow-bs2 w-full"></div>
